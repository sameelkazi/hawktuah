      ...
      <section className="flex-1 flex items-center justify-center p-8 relative z-10">
        <div className="w-full max-w-md">
          <div className="flex flex-col gap-6">
            ...
            <button onClick={onGoogleSignUp} className="animate-element animate-delay-800 w-full flex items-center justify-center gap-3 border border-slate-200 dark:border-white/10 bg-white dark:bg-white/5 rounded-2xl py-4 hover:bg-slate-100 dark:hover:bg-white/10 transition-colors text-slate-700 dark:text-white font-medium">
                <GoogleIcon />
                Sign up with Google
            </button>
